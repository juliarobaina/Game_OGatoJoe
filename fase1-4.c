			...
			if(IMG_Init(IMG_INIT_PNG) < 0){
				...
				*/
				...
				/* ---------------- INÍCIO DO TIMER -----------------------*/
						...
						//jogar...3 foi substituido por min...
				   		minSurface = TTF_RenderUTF8_Solid(font,st,color);
						minRect.x = 210;
						minRect.y = 100;//- (jogarSurface->h/2);
						minRect.w = 500;
						minRect.h = 500;
						...
						//jogar...4 foi substituido por sepa
						sepaSurface = TTF_RenderUTF8_Solid(font,":",color);
						sepaRect.x = 240;
						sepaRect.y = 100;//- (jogarSurface->h/2);
						sepaRect.w = 500;
						sepaRect.h = 500;
						...
						//jogar...2 foi substituido por seg
						segSurface = TTF_RenderUTF8_Solid(font,pokemon,color);
						segRect.x = 260;//230
						segRect.y = 100;//- (jogarSurface->h/2);
						segRect.w = 500;
						segRect.h = 500;
						...
						if(seg < 10){
							...
							zeroRect.x = 255;
							zeroRect.y = 100;//- (jogarSurface->h/2);
							zeroRect.w = 500;
							zeroRect.h = 500;
