...
void cair(SDL_Rect* dRectGatoJoe){
	...
	if(!((dRectGatoJoe->x >= 449 && dRectGatoJoe->x <= 529) || (dRectGatoJoe->x >= 526 && dRectGatoJoe->x <= 668) || 
	(dRectGatoJoe->x >= 0 && dRectGatoJoe->x <= 214 && !PODEDESCER) ||  (dRectGatoJoe->x >= 197 && dRectGatoJoe->x <= 330 && PODEDESCER) || 
	(dRectGatoJoe->x >= 0 && dRectGatoJoe->x <= 196 && PODEDESCER) || (dRectGatoJoe->x >= 570 && dRectGatoJoe->y <= 96 && PODEDESCER))){
...
void colisaoBlocoBaixo5E(SDL_Rect* dRectGatoJoe,SDL_Rect a,SDL_Rect b){
    ...
    if(lazyFoo(a,b) && dRectGatoJoe->y > 70){
        dRectGatoJoe->x += 6;
    }
